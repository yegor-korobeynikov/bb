...
/**
 * Default ON, matching Claude Code's composer: typing Markdown
 * (`# `, `- `, `1. `, `**`, `_`, `` ` ``) live-formats into headings, lists,
 * bold, italic, and inline code in the composer (see
 ...
 */
const RICH_TEXT_EDITING_DEFAULT = true;
